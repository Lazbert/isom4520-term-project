...
class AllStocksPrices:
    ...
    def load(self):
        ...
        if market.startswith("US") or market.startswith("US-TERM"):
            ...
            self.market_index = load_data_from_yahoo_finance(
                "SPY", market_macro_index=True, **params_to_pass
            )
            self.russel_2000 = load_data_from_yahoo_finance(
                "IWM", market_macro_index=True, **params_to_pass
            )
            self.nasdaq_100 = load_data_from_yahoo_finance(
                "QQQ", market_macro_index=True, **params_to_pass
            )
